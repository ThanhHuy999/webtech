<?php
    ...
    pg_query("INSERT INTO BAI_VIET(TIEU_DE_BAI_VIET, CHUYEN_MUC, ANH_DAI_DIEN, TEN_TAC_GIA) VALUES ('Hom nay la 1 ngay khong dep','Nen tang tri thuc','abc','Thanh Huy 9');");
    echo("xin chao");
?>